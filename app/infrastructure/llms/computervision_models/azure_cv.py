...
from app.infrastructure.llms.computervision_models.base.openai_base import OpenAIBase
from app.infrastructure.llms.computervision_models.base.base import CONNECTION_TIMEOUT, MAX_RETRY_ATTEMPTS
